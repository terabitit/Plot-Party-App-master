...
class IntroScreensApproval extends StatefulWidget {
  final SharedPrefData sharedPrefData;

  const IntroScreensApproval({Key key, this.sharedPrefData}) : super(key: key);
  @override
  _IntroScreensApprovalState createState() => _IntroScreensApprovalState();
}

class _IntroScreensApprovalState extends State<IntroScreensApproval> {
  final introKeyApproval = GlobalKey<IntroductionScreenState>();
    ...
    return Scaffold(
      body: Padding(
        ...
        child: IntroductionScreen(
          key: introKeyApproval,
          globalBackgroundColor: Color(0xff1e1e1e),
          pages: [
            PageViewModel(
              title: "you have submitted your request.",
              body: "wait for the host to approve you.",
              image: _buildImage('aft1.jpg'),
            ...
            PageViewModel(
              ...
              body: "be sure to check back to see if the host approved you!",
              decoration: pageDecoration.copyWith(
                bodyFlex: 2,
                imageFlex: 4,
