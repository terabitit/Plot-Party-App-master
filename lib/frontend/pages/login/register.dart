...
class Register extends StatefulWidget {
  // Register page if logged out and registering as new user, although I have to work around the fact that the account is based around phone number
  final List takenUsernames;
  final List takenPhoneNumbers;

  const Register({Key key, this.takenUsernames, this.takenPhoneNumbers}) : super(key: key);
  @override
  _RegisterState createState() => _RegisterState();
}

class _RegisterState extends State<Register> {
  // implement check for checking if user exists
  String phoneNumber;
  String username;
  final _registerUserForm = GlobalKey<FormState>();
        ...
        body: SingleChildScrollView(child:Column(
          ...
          children: [
            ...
            NextButton(
              text: 'register',
              callback: ()async {
                if (_registerUserForm.currentState.validate()){
